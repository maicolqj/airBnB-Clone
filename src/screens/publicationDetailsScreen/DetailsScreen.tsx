...
const DetailsScreen = ({ navigation, route }: Props) => {
  ...
  return (
    <SafeAreaView style={[customStyles.safeArea,{paddingTop:0}, !isLoadingPublicationSlug && styles.container]}>
      {
        isLoadingPublicationSlug ?
          <LoadingData/>
        :
        <>
          ...
          <ScrollView style={{  marginBottom: hp('2% '), }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ ...styles.boxCards }}>
              <FastImage source={{uri:publicationSelected?.user?.image ,priority:'high'}}
